...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        call.result.expectOk().expectUint(99660772);
        ...
        call.result.expectOk().expectUint(78367540);

        // Check pool details and print
        call = await YCRPTest.getPoolDetails(wbtcAddress, yieldusdaAddress, expiry);
        let position:any = call.result.expectOk().expectTuple();
        position['yield-supply'].expectUint(78101696);
        position['key-supply'].expectUint(78101696);
        ...
        position['balance-y'].expectUint(33196400);
        ...
        position = result.expectOk().expectTuple();
        position['dx'].expectUint(22160808954);
        ...
        position = result.expectOk().expectTuple();
        position['dy'].expectUint(7702633);        
        position['dx'].expectUint(7702782);   
        ...
        call.result.expectOk().expectUint(52703566);                     
        ...
        call = await YCRPTest.getPoolValueInToken(wbtcAddress, yieldusdaAddress, usdaAddress, expiry);
        call.result.expectOk().expectUint(109241079); 
        ...
        position['dy'].expectUint(78101696);

        // most of yield-token burnt, but key-token remains
        call = await YCRPTest.getPoolDetails(wbtcAddress, yieldusdaAddress, expiry);
        position = call.result.expectOk().expectTuple();
        position['balance-x'].expectUint(0);
        position['balance-y'].expectUint(9590021);                
        position['yield-supply'].expectUint(7702633);
        position['key-supply'].expectUint(85804329);
        ...
        position = result.expectOk().expectTuple();
        position['dx'].expectUint(0);
        position['dy'].expectUint(1887387);     
        ...
        position['balance-x'].expectUint(0);
        position['balance-y'].expectUint(7702634);                
    },    
});
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        call.result.expectOk().expectUint(98139809581);
        result = YCRPTest.swapXForY(deployer, wbtcAddress, yieldusdaAddress,usdaAddress, expiry, 98139809581, 0);
        let position:any = result.expectOk().expectTuple();
        position['dx'].expectUint(98139809581);
        position['dy'].expectUint(1864316);
        
        call = await YCRPTest.getYgivenPrice(wbtcAddress, yieldusdaAddress, expiry, Math.round( ONE_8 / (wbtcPrice * 1.1 * 0.98/ ONE_8)));
        call.result.expectOk().expectUint(1306196);
        result = YCRPTest.swapYForX(deployer, wbtcAddress, yieldusdaAddress, usdaAddress, expiry, 1306196, 0);
        position = result.expectOk().expectTuple();
        position['dx'].expectUint(72623333705);
        position['dy'].expectUint(1306196);   
    },    
});  
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        call.result.expectOk().expectUint(2605480014137);

        call = await YCRPTest.getLtv(wbtcAddress, yieldusdaAddress, usdaAddress, expiry);
        call.result.expectOk().expectUint(90040626);

        // pegged CRP throws error if someone tries to swap
        call = await YCRPTest.getXgivenPrice(wbtcAddress, yieldusdaAddress, expiry, Math.round( ONE_8 / (wbtcPrice * 1.1 / ONE_8)));
        call.result.expectOk().expectUint(106089910142);
        result = YCRPTest.swapXForY(deployer, usdaAddress, yieldusdaAddress, wbtcAddress, expiry, 106089910142, 0);
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        result = YCRPTest.addToPosition(deployer, wbtcAddress, yieldusdaAddress, usdaAddress, expiry, yieldwbtcAddress, keywbtcAddress, 0.31 * Math.round(wbtcPrice * wbtcQ / ONE_8));
...
Clarinet.test({
    ...
    async fn (chain: Chain, accounts: Map<string, Account>) {
        ...
        call.result.expectOk().expectUint(1980);
        ...
        call.result.expectOk().expectUint(25016121);
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        ROresult.result.expectOk().expectUint(78101696);
