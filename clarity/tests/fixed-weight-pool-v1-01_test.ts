...
Clarinet.test({
    name: "fixed-weight-pool-v1-01 : pool creation, adding values and reducing values",
...
Clarinet.test({
    name: "fixed-weight-pool-v1-01 : trait check",
...
Clarinet.test({
    name: "fixed-weight-pool-v1-01 : fee setting using multisig ",
...
Clarinet.test({
    name: "fixed-weight-pool-v1-01 : error testing",
...
Clarinet.test({
    name: "fixed-weight-pool-v1-01 : testing get-x-given-price and get-y-given-price",
