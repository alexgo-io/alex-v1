import {
  ...
  const fwpwstxusdaAddress =
    "ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.fwp-wstx-usda-50-50-v1-01";
  const multisigfwpwstxusda =
    "ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.multisig-fwp-wstx-usda-50-50-v1-01";
  ...
  Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      call.result.expectOk().expectUint(99651765);
        
      call = await CRPTest.getLtv(wbtcAddress, usdaAddress, expiry);
      call.result.expectOk().expectUint(78320290);
      ...
      position["balance-y"].expectUint(33188320);
      ...
      call = await CRPTest.getPoolValueInToken(wbtcAddress, usdaAddress, expiry);
      call.result.expectOk().expectUint(19511172);
      ...
      position["balance-y"].expectUint(19511172);  
      ...
      position = result.expectOk().expectTuple();
      position["dx"].expectUint(0);
      position["dy"].expectUint(19511172);
      ...
      call.result.expectOk().expectUint(9991097558724);
