import {
  ...
  Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      call.result.expectOk().expectUint(99897987);
        
      call = await CRPTest.getLtv(wbtcAddress, usdaAddress, expiry);
      call.result.expectOk().expectUint(80081693);
      ...
      position["weight-x"].expectUint(94523390);
      position["weight-y"].expectUint(ONE_8 - 94523390);
      position["balance-x"].expectUint(4726169500000);
      position["balance-y"].expectUint(5469121);
      ...
      call = await CRPTest.getPoolValueInToken(wbtcAddress, usdaAddress, expiry);
      call.result.expectOk().expectUint(18139698);
      ...
      position["key-supply"].expectUint(80000000);
      position["balance-x"].expectUint(698404721361);
      position["balance-y"].expectUint(4220492);  
      ...
      position = result.expectOk().expectTuple();
      position["dx"].expectUint(698404721361);
      position["dy"].expectUint(4220492);
