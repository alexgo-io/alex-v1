...
;; This prototype is for ayyield-usda-74880-yield-usda-74880 pool token. 
...
(define-read-only (is-token-accepted (token <ft-trait>))
    (or (is-eq (contract-of token) .yield-usda-23040) (is-eq (contract-of token) .key-usda-23040-yield-usda-74880))
)
...
(define-public (propose
  ...
  (let 
    (
      (proposer-yield-balance (unwrap-panic (contract-call? .yield-usda-23040 get-balance tx-sender)))
      (proposer-key-balance (unwrap-panic (contract-call? .key-usda-23040-yield-usda-74880 get-balance tx-sender)))
      (proposer-balance (+ proposer-yield-balance proposer-key-balance))
      (total-yield-supply (unwrap-panic (contract-call? .yield-usda-23040 get-total-supply)))
      (total-key-supply (unwrap-panic (contract-call? .key-usda-23040-yield-usda-74880 get-total-supply)))
...
(define-private (execute-proposal (proposal-id uint))
  (let 
    ...
    (try! (contract-call? .collateral-rebalancing-pool set-fee-rate-x .token-usda .yield-usda-74880 u2304000000000 new-fee-rate-x))
    (try! (contract-call? .collateral-rebalancing-pool set-fee-rate-y .token-usda .yield-usda-74880 u2304000000000 new-fee-rate-y))
    (try! (contract-call? .collateral-rebalancing-pool set-fee-rebate .token-usda .yield-usda-74880 u2304000000000 new-fee-rebate))
