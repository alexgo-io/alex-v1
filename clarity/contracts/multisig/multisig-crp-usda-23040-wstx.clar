...
(define-read-only (is-token-accepted (token <ft-trait>))
    (or (is-eq (contract-of token) .yield-usda-23040) (is-eq (contract-of token) .key-usda-23040-wstx))
)
...
(define-public (propose
  ...
  (let 
    (
      ...
      (proposer-key-balance (unwrap-panic (contract-call? .key-usda-23040-wstx get-balance tx-sender)))
      ...
      (total-key-supply (unwrap-panic (contract-call? .key-usda-23040-wstx get-total-supply)))
