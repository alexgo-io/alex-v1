...
;; @desc get the intrinsic value of auto-alex-v2
;; @desc intrinsic = next capital base of the vault / total supply of auto-alex-v2
...
;; @desc transfers dx to vault, stake them for 32 cycles and mints auto-alex-v2, the number of which is determined as % of total supply / next base
...
;; claims alex for the reward-cycles and mint auto-alex-v2
