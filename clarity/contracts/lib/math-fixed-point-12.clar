...
;; constants
;;
(define-constant ONE_12 (pow u10 u12)) ;; 12 decimal places
...
(define-constant MAX_POW_RELATIVE_ERROR u6) 
;; public functions
;;
...
(define-read-only (pow-down (a uint) (b uint))    
    (let
        (
            (raw (unwrap-panic (contract-call? .math-log-exp-12 pow-fixed a b)))
