...
(use-trait flash-loan-user-trait .trait-flash-loan-user-v1.flash-loan-user-trait)
...
(define-trait vault-trait
    (   
        ...
        ;; (get-fees (<ft-trait> <ft-trait>) (response (list 2 uint) uint))   ;; WHAT IS THE DIFFERENCE WITH COLLECT?
