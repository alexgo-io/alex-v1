...
(define-fungible-token fwp-alex-wbtc-50-50-v1-01)
...
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://cdn.alexlab.co/metadata/fwp-alex-wbtc-50-50.json"))
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    ...
    (try! (ft-transfer? fwp-alex-wbtc-50-50-v1-01 amount sender recipient))
...
(define-read-only (get-balance (who principal))
	(ok (ft-get-balance fwp-alex-wbtc-50-50-v1-01 who))
)

(define-read-only (get-total-supply)
	(ok (ft-get-supply fwp-alex-wbtc-50-50-v1-01))
)
...
(define-public (mint (amount uint) (recipient principal))
	(begin		
		...
		(ft-mint? fwp-alex-wbtc-50-50-v1-01 amount recipient)
	)
)
...
(define-public (burn (amount uint) (sender principal))
	(begin
		(asserts! (or (is-ok (check-is-approved)) (is-ok (check-is-owner))) ERR-NOT-AUTHORIZED)
		(ft-burn? fwp-alex-wbtc-50-50-v1-01 amount sender)
	)
)
