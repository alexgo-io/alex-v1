...
(define-read-only (get-spot (token principal) (collateral principal))
    (if (is-eq token .token-wstx)
        (contract-call? .fixed-weight-pool-v1-01 get-oracle-resilient collateral .token-wstx u50000000 u50000000)
        (if (is-eq collateral .token-wstx)
            (contract-call? .fixed-weight-pool-v1-01 get-oracle-resilient .token-wstx token u50000000 u50000000)
            (ok
                (div-down                
