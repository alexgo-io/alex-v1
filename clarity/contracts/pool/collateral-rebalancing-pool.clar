    ...
    (let
        ...
        (and (> fee-x u0) 
            (and 
                ...
                (unwrap! (contract-call? .token-alex transfer 
                    (if (is-eq token-x .token-alex) fee-x-rebate (get dx (try! (contract-call? .fixed-weight-pool swap-y-for-x .token-alex collateral u50000000 u50000000 fee-x-rebate)))) 
                ...
                (unwrap! (contract-call? .token-usda transfer 
                    (if (is-eq token-x .token-usda) fee-x-net (get dx (try! (contract-call? .fixed-weight-pool swap-y-for-x .token-usda collateral u50000000 u50000000 fee-x-net)))) 
        ...
        (and (> fee-y u0) 
            (and 
                ...
                (unwrap! (contract-call? .token-alex transfer 
                    (if (is-eq token-y .token-alex) fee-y-rebate (get dx (try! (contract-call? .fixed-weight-pool swap-y-for-x .token-alex token u50000000 u50000000 fee-y-rebate)))) 
                    tx-sender address none) transfer-y-failed-err) 
                (unwrap! (contract-call? .token-usda transfer 
                    (if (is-eq token-y .token-usda) fee-y-net (get dx (try! (contract-call? .fixed-weight-pool swap-y-for-x .token-usda token u50000000 u50000000 fee-y-net)))) 
