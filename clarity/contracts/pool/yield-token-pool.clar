    ...
    (let
        ...
        (and (> fee-x u0) 
            (and 
                ...
                (unwrap! (contract-call? .token-alex transfer 
                    (if (is-eq aytoken .token-alex) fee-x-rebate (get dx (try! (contract-call? .fixed-weight-pool swap-y-for-x .token-alex the-aytoken u50000000 u50000000 fee-x-rebate)))) 
                ...
                (unwrap! (contract-call? .token-usda transfer 
                    (if (is-eq aytoken .token-usda) fee-x-net (get dx (try! (contract-call? .fixed-weight-pool swap-y-for-x .token-usda the-aytoken u50000000 u50000000 fee-x-net)))) 
        ...
        (and (> fee-y u0) 
            (and 
                ...
                (unwrap! (contract-call? .token-alex transfer 
                    (if (is-eq token .token-alex) fee-y-rebate (get dx (try! (contract-call? .fixed-weight-pool swap-y-for-x .token-alex the-token u50000000 u50000000 fee-y-rebate)))) 
                    tx-sender address none) transfer-y-failed-err) 
                (unwrap! (contract-call? .token-usda transfer 
                    (if (is-eq token .token-usda) fee-y-net (get dx (try! (contract-call? .fixed-weight-pool swap-y-for-x .token-usda the-token u50000000 u50000000 fee-y-net)))) 
