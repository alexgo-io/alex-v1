...
(define-private (get-staker-at-cycle-or-default-by-tx-sender (reward-cycle uint))
  (contract-call? .alex-reserve-pool-v7 get-staker-at-cycle-or-default .token-t-alex reward-cycle (default-to u0 (contract-call? .alex-reserve-pool-v7 get-user-id .token-t-alex tx-sender)))
)
...
(define-private (get-staking-reward-by-tx-sender (target-cycle uint))
  (contract-call? .alex-reserve-pool-v7 get-staking-reward .token-t-alex (default-to u0 (contract-call? .alex-reserve-pool-v7 get-user-id .token-t-alex tx-sender)) target-cycle)
)
...
(define-private (claim-staking-reward-by-tx-sender (reward-cycle uint))
  (contract-call? .alex-reserve-pool-v7 claim-staking-reward .token-t-alex reward-cycle)
)
