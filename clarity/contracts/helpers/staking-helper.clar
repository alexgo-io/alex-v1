...
(define-read-only (get-staked (token principal) (reward-cycles (list 2000 uint)))
  (map 
...
(define-read-only (get-staking-rewards (token principal) (reward-cycles (list 2000 uint)))
  (map 
