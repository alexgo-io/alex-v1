...
(use-trait sft-trait .trait-sft-transfer-fixed.sft-transfer-fixed-trait)
(use-trait flash-loan-trait .trait-flash-loan-user-fixed.flash-loan-user-fixed-trait)
