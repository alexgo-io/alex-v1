...
(define-read-only (get-balance (account principal))
  (ok (/ (* (unwrap-panic (contract-call? .token-diko get-balance account)) (pow-decimals)) (pow u10 u6)))
  ;; SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.diko-token
)
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin
    ...
    (contract-call? .token-diko transfer (/ (* amount (pow u10 u6)) (pow-decimals)) sender recipient memo)
  )
)
