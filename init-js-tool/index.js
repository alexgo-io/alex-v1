                        ...
                        if (dy.type === 7 && dy.value.value > 0n) {
                            ...
                            if (dx.type == 7 && dx_fwp.type == 7) {
                                ...
                                for (let i = 0; i < 4; i++) {
                                    ...
                                    let dx_fwp_i;
                                    if (_deploy[key]['collateral'] == 'token-usda') {
                                        dx_fwp_i = await fwpGetXgivenY(_deploy[key]['token'], _deploy[key]['collateral'], 0.5e+8, 0.5e+8, dy_ltv);
                                    } else {
                                        dx_fwp_i = await fwpGetYgivenX(_deploy[key]['collateral'], _deploy[key]['token'], 0.5e+8, 0.5e+8, dy_ltv);
                                    }
